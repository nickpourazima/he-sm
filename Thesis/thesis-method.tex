...
The haptic test cases were broken down into dictionary lists containing arguments to be passed to the \texit{haptic} method. The arguments were dependent on the mode of operation the test case called for, the tempo desired, the time of execution, and whether the tempo was to change dynamically over time.
