...
The dynamic tests involved manipulation of the tempo. This task was accomplished in \textit{Logic Pro X} through automation of the tempo parameter over the time period of the desired waveform. Each test case started on one of the pre-defined BPM's (45,90,135,180) but traversed either sinusoidally or triangular through peaks and troughs ranging plus or minus 15 bpm as shown in \ref{fig:dynamic_audio}.
