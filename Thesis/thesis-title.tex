...
\title{\textbf{An evaluation of the interstitial beat across multi-sensory modalities for characterization of a meaningful haptic enviro-sensing metronome}\\ \vspace{12pt}}
